...
static void sconv_sse_unit_test_aux(void (*sconv_func) (unsigned n, const float *a, int16_t *b)) {
    ...
    sconv_func(SAMPLES, floats, samples);
...
void sconv_sse_unit_test() {
    ...
    sconv_sse_unit_test_aux(pa_sconv_s16le_from_f32ne_sse);
}
